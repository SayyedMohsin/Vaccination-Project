...
CREATE INDEX IF NOT EXISTS idx_cov_iso3_year_antigen 
  ON fact_coverage(iso3, year, antigen);
...
CREATE INDEX IF NOT EXISTS idx_inc_iso3_year_disease 
  ON fact_incidence(iso3, year, disease);
...
CREATE INDEX IF NOT EXISTS idx_cases_iso3_year_disease 
  ON fact_cases(iso3, year, disease);
...
CREATE INDEX IF NOT EXISTS idx_intro_iso3_antigen 
  ON dim_vaccine_intro(iso3, antigen);
...
CREATE INDEX IF NOT EXISTS idx_sch_iso3_year_antigencode 
  ON dim_schedule(iso3, year, antigen_code);
